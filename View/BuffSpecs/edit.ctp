<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BuffSpec.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BuffSpec.id'))); ?></li>
...
<?php echo $this->Form->create('BuffSpec'); ?>
	<fieldset>
		<legend><?php echo __('Edit Buff Spec'); ?></legend>
	<?php
