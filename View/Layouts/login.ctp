...
<html lang="en" class="login_page">
    <head>
        ...
        <title>TCS TireCore - Login Page</title>
        <?php $path = '/coreui/gebo_admin_1.6/'; ?>
        <!-- Bootstrap framework -->
    ...
    <body>
		...
		<div class="login_box">
			...
			<form method="post" action="/users/login" id="login_form">
				<div class="top_b">Sign in to TireCore</div>
				...
				<div class="cnt_b">
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span><input type="text" id="username" name="data[User][username]" placeholder="Username" value="" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="password" id="password" name="data[User][password]" placeholder="Password" value="" />
						</div>
					</div>
			...
			<!--<form action="dashboard.html" method="post" id="reg_form" style="display:none">
				...
				<div class="cnt_b">
					...
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span><input type="text" placeholder="Username" value="data[User][username]" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="text" placeholder="Password" value="data[User][password]" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
