<div class="preferences">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('value_type'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($preference['Preference']['type']); ?>&nbsp;</td>
		<td><?php echo h($preference['Preference']['key_id']); ?>&nbsp;</td>
		<td><?php echo h($preference['Preference']['name']); ?>&nbsp;</td>
		<td><?php echo h($preference['Preference']['value']); ?>&nbsp;</td>
		<td><?php echo h($preference['Preference']['value_type']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $preference['Preference']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $preference['Preference']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
