<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TreadWidth.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TreadWidth.id'))); ?></li>
...
<?php echo $this->Form->create('TreadWidth'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tread Width'); ?></legend>
	<?php
