<div class="jockeys">
	...
	<tr>
		<td><?php echo h($jockey['Jockey']['id']); ?>&nbsp;</td>
		<td><?php echo h($jockey['Jockey']['name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $jockey['Jockey']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $jockey['Jockey']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $jockey['Jockey']['id']), null, __('Are you sure you want to delete # %s?', $jockey['Jockey']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
    </tbody>
