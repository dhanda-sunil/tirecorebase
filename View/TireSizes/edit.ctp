<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TireSize.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TireSize.id'))); ?></li>
...
<?php echo $this->Form->create('TireSize'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tire Size'); ?></legend>
	<?php
