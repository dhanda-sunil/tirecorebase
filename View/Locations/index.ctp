<div class="locations">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('location_group_id'); ?></th>
			<th><?php echo $this->Paginator->sort('location_type'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($location['Location']['company_id']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['name']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['description']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['location_group_id']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['location_type']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['modified']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['created']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['deleted']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['deleted_by']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $location['Location']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $location['Location']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
