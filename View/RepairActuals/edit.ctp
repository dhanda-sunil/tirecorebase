<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RepairActual.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RepairActual.id'))); ?></li>
...
<?php echo $this->Form->create('RepairActual'); ?>
	<fieldset>
		<legend><?php echo __('Edit Repair Actual'); ?></legend>
	<?php
