<div class="phoneNumbers">
	...
	<tr>
		...
		<td><?php echo h($phoneNumber['PhoneNumber']['ref_id']); ?>&nbsp;</td>
		<td><?php echo h($phoneNumber['PhoneNumber']['ref_table']); ?>&nbsp;</td>
		<td><?php echo h($phoneNumber['PhoneNumber']['value']); ?>&nbsp;</td>
		<td><?php echo h($phoneNumber['PhoneNumber']['type']); ?>&nbsp;</td>
		<td><?php echo h($phoneNumber['PhoneNumber']['primary']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $phoneNumber['PhoneNumber']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $phoneNumber['PhoneNumber']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
