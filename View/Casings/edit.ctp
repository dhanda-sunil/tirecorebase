<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Casing.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Casing.id'))); ?></li>
...
<?php echo $this->Form->create('Casing'); ?>
	<fieldset>
		<legend><?php echo __('Edit Casing'); ?></legend>
	<?php
