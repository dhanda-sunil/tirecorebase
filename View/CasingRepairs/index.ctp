<div class="casingRepairs" style="width:800px;">
    <div class="navbar">
    ...
    <tbody>
	<?php
	foreach ($casingRepairs as $casingRepair): ?>
	<tr>
		<td><?php echo h($casingRepair['CasingRepair']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($casingRepair['CasingRepair']['quantity']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $casingRepair['CasingRepair']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $casingRepair['CasingRepair']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $casingRepair['CasingRepair']['id']), null, __('Are you sure you want to delete # %s?', $casingRepair['CasingRepair']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
    </tbody>
