<div class="actions">
    <div class="navbar">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CasingRepair.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CasingRepair.id'))); ?></li>
...
<?php echo $this->Form->create('CasingRepair'); ?>
	<fieldset>
		<legend><?php echo __('Edit Casing Repair'); ?></legend>
	<?php
