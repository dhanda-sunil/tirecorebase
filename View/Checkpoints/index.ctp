<div class="checkpoints">
	...
	<tr>
		<td><?php echo h($checkpoint['Checkpoint']['id']); ?>&nbsp;</td>
		<td><?php echo h($checkpoint['Checkpoint']['name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(' '), array('action' => 'view', $checkpoint['Checkpoint']['id']), array('class'=>'icon-search', 'title'=>'View')); ?>
			<?php echo $this->Html->link(__(' '), array('action' => 'edit', $checkpoint['Checkpoint']['id']), array('class' => 'icon-edit', 'title'=>'Edit')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $checkpoint['Checkpoint']['id']), null, __('Are you sure you want to delete # %s?', $checkpoint['Checkpoint']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
    </tbody>
