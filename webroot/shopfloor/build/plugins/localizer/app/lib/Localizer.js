Ext.define("Ext.ux.Localizer", {
    ...
    localize2 : function(comp, localizeChildren) {
        ...
        if (Ext.grid && Ext.grid.column && Ext.grid.column.Column &&
            comp instanceof Ext.grid.column.Column && this.localizableColumns && this.localizableColumns.indexOf(comp.dataIndex)>-1) {
    ...
    loadLocaleStrings: function(locale) {
        ...
        Ext.Ajax.request({
            url : "/Bancha/Bancha/translation/" + locale + ".js",
            async : false,
    ...
    **
    ...
    // let Bancha handle the translations
    getLocalizedString: function() {
        return Bancha.Localizer.getLocalizedString.apply(Bancha.Localizer,arguments);
    },
    getLocaleStrings: function() {
        return Bancha.Localizer.getLocaleStrings.apply(Bancha.Localizer,arguments);
    }
});
