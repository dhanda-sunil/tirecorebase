$(function() {
    ...
    Molds = {
        ...
        init: function(){
            ...
            if($('#page-title').text() != 'Molds'){
                $.get('/molds/index',function(response){
        ...
        ,index: function(){
            ...
            $('#collapse2 li:first-child').addClass('active');
            
            // init dataTables
            var dataTable = $('#molds-table').dataTable({
                "iDisplayLength": 100,
                "bProcessing": true,
                "bServerSide": true,
                ...
                "fnCreatedRow": function(nRow, aData, iDataIndex){
                    $('td:eq(0)', nRow).html('<a href="javascript:Molds.view('+aData[7]+')">'+aData[0]+'</a>');
                    $('td:eq(1)', nRow).html('<span title="'+aData[8]+'">'+aData[1]+'</span>');
                }
            });
        }
        ,add: function(){
            ...
            // change title
            $('#page-sub-title').html('<br/>Add Mold');
            // clone template
        ...
        ,view: function(id){
            ...
            $.get('/molds/view/'+id+'.json',function(record){
