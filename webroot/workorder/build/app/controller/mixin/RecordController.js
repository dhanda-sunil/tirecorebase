...
/**
 * @class WorkOrder.controller.mixin.RecordController
 *
 ...
 */
Ext.define('WorkOrder.controller.mixin.RecordController', {
    ...
    loadRecordFromModel: function(config, record) {
        ...
        if(Ext.isNumeric(record)) {
            ...
            loadRecId = record.get(this.getDatabaseIdFieldname(config.modelName));
        }
